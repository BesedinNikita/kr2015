...
public class Snake {
    ...
    private void changeTailPoint(int appendX, int appendY){
        Point point = snakeList.getFirst().getPoint();
        int x = (point.x + appendX) % GameBoard.FIELD_SIZE;
        int y = (point.y + appendY) % GameBoard.FIELD_SIZE;
